$(document).on('turbolinks:load',function(){
    ...
    $(".new_user").validate({
        ...
        rules: {
            ...
            "item[child_category_id]": {required:true},
            "item[grandchild_category_id]": {required:true},
        ...
        messages: {
            ...
            "item[child_category_id]": {required: "選択してください"},
            "item[grandchild_category_id]": {required: "選択してください"},
